    ...
    <div class="content has-text-centered" style="padding: 50px 10px;">
      ...
      <div class="container has-text-centered">
        <div class="columns is-centered">
          <div class="column is-5 is-10-desktop">
            <div style="text-align: left; font-size: 1rem; color: #363636;">
              The terms "We"/"Us"/"Our"/”Company” individually and collectively
              refer to "noobtronics", which is a subsidiary of "Luminol
              Technologies Pvt. Ltd." <br /><br />The terms "Visitor” / ”User”
              ...
              Us (both terms defined below). The terms of this Privacy Policy
              ...
              Policy, please do not use this Website. <br /><br />
              ...
              <h2 class="title is-6" style="margin-top: 20px;">
                User Information
              </h2>
              ...
              provide you the most user-friendly experience. <br /><br />
              ...
              <h2 class="title is-6" style="margin-top: 20px;">Cookies</h2>
              ...
              limited circumstances: <br /><br />
              (a)&nbsp;When it is requested or required by law or by any court
              or governmental agency or authority to disclose, for the purpose
              ...
              available to anyone with Internet access.&nbsp; <br /><br />
              ...
              electronic signature to&nbsp;"Grievance Officer" <br /><br />
              Gerivance Officer<br />
              <b>Luminol Technologies Pvt. Ltd.</b><br />
              Shop No. 3/4, Trimurth Complex, <br />
              Samarth Nagar, Aurangabad, <br />
...
export default {
  ...
  head() {
    return {
      title: 'Privacy Policy - noobtronics',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Privacy Policy of noobtronics',
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'privacy policy, noobtronics',
        },
      ],
    }
  },
