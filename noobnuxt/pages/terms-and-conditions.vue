        ...
        <div class="columns is-centered">
          <div class="column is-5 is-10-desktop">
            <div style="text-align: left; font-size: 1rem; color: #363636;">
              ...
              <h2 class="title is-7" style="">(A) Security Rules</h2>
              ...
              in such violations.
              <h2 class="title is-7" style="">(B) General Rules</h2>
              ...
              <h2 class="title is-6" style="margin-top: 20px;">Indemnity</h2>
              ...
              from or resulting from their use of noobtronics.ltd or their
              breach of the terms .
              <h2 class="title is-6" style="margin-top: 20px;">Liability</h2>
              ...
              or/and use or/and data or other intangible, even
              if&nbsp;Company&nbsp;has been advised of the possibility of such
              damages. <br /><br />
              User further agrees that&nbsp;Company&nbsp;shall not be liable for
              any damages arising from interruption, suspension or termination
              ...
              User agrees that&nbsp;Company&nbsp;shall not be responsible or
              ...
              causes of action exceed the amount paid by the User
...
export default {
  ...
  head() {
    return {
      title: 'Terms and Conditions - noobtronics',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Terms and Conditions of noobtronics',
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'terms and conditions, noobtronics',
        },
      ],
    }
  },
