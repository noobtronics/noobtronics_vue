      ...
      <div class="container" style="width: 100%;">
        ...
        <div class="navbar-menu" :class="{ 'is-active': isMenuBarActive }">
          <div class="navbar-start">
            ...
            >
              <a class="navbar-link" @click="isShop = !isShop">Shop</a>
        ...
        <div class="navbar-menu" :class="{ 'is-active': isAccountMenuActive }">
          <div class="navbar-start">
            <div
              class="navbar-item has-dropdown is-hoverable"
              :class="{ 'is-active': isAccountMenuActive }"
            >
              <button class="button navbarbtn is-hidden-mobile">
                <span class="icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
